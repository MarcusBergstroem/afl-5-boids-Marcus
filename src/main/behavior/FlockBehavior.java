...
public class FlockBehavior implements BehaviorStrategy {
    ...
    public Vector2D calculateSeparation(Boid boid, List<Boid> neighbors, FlockWeights weights) {
    ...
    public Vector2D calculateAlignment(Boid boid, List<Boid> neighbors, FlockWeights weights) {
    ...
    public Vector2D calculateCohesion(Boid boid, List<Boid> neighbors, FlockWeights weights) {
